...
namespace AenEnterprise.DomainModel.AccountsAndFinance.AccountReceivable.SalesManagement
{
    public class DeliveryOrderItem
    {
            ...
            bool isActive)
        {
            ...
            _dispatchAmount = orderItem.Price * deliveryQuantity;
            _deliveryQuantity = deliveryQuantity;
            _deliveryAmount = orderItem.Price * deliveryQuantity;
            IsPartiallyApproved = false;
            IsFullyApproved = false;
            StatusId = statusId;
            IsActive = isActive;
            _balanceAmount = orderItem.Price * deliveryQuantity;
        ...
        public void SetBalanceQuantity(decimal quantity)
        {
            ...
            DeliveryAmount = DeliveryQuantity * OrderItem.Price;
